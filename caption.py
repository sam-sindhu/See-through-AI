...
engine = pyttsx3.init()
 ...
 #st.set_page_config(page_title="See through AI", layout="wide", page_icon="🧠")
st.markdown(
    """
    <style>
     .main-title {
...
st.markdown('<div class="main-title">See through AI 👁️</div>', unsafe_allow_html=True)
st.markdown('<div class="subtitle"> AI Solution for Empowering the Partially Sighted 🗣️</div>', unsafe_allow_html=True)

# Sidebar Features
st.sidebar.image(
    r"C:\Users\samudrala sindhuja\Downloads\Tag.jpg",
    width=250
)
...
st.sidebar.markdown(
    ...
    💡 **How it helps**:
    Assists Partially Sighted users by providing scene descriptions, text extraction, and speech.
...
input_prompt = """
You are an AI assistant helping Partially Sighted individuals by describing the scene in the image. Provide:
1. List of items detected in the image with their purpose.
2. Overall description of the image.
3. Suggestions for actions or precautions for the partially sighted.
"""
...
st.markdown(
    ...
    <footer style="text-align:center;">
        <p>Powered by <strong>Google Gemini API</strong> |👤 Samudrala Sindhuja | Built with ❤️ using Streamlit</p>
    </footer>
    """,
    unsafe_allow_html=True,
)
